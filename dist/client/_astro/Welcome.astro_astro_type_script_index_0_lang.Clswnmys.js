...
function yr(r, e) {
  ...
  function h(m) {
    ...
    return (
      i < 1
        ? (v =
            Math.exp(-v * i * f) * (s * Math.cos(p * v) + l * Math.sin(p * v)))
...
var jr = (function () {
    ...
    function f(s, l, h, w, m) {
      var v,
        b,
        M = 0;
      do (b = l + (h - l) / 2), (v = u(b, w, m) - s), v > 0 ? (h = b) : (l = b);
    ...
    function p(s, l, h, w) {
      ...
      if (s !== l || h !== w) for (var v = 0; v < r; ++v) m[v] = u(v * e, s, h);
      function b(M) {
        for (var g = 0, d = 1, P = r - 1; d !== P && m[d] <= M; ++d) g += e;
        --d;
        var k = (M - m[d]) / (m[d + 1] - m[d]),
          x = g + k * e,
          L = o(x, s, h);
        return L >= 0.001 ? i(M, x, s, h) : L === 0 ? x : f(M, g, g + e, s, h);
      }
      return function (M) {
        return (s === l && h === w) || M === 0 || M === 1 ? M : u(b(M), l, w);
      };
    }
    return p;
  })(),
...
function _(r, e) {
  var n = rr(r);
  for (var a in r) n[a] = e.hasOwnProperty(a) ? e[a] : r[a];
  return n;
}
function N(r, e) {
  var n = rr(r);
  for (var a in e) n[a] = c.und(r[a]) ? e[a] : r[a];
  return n;
}
function zr(r) {
...
function Rr(r) {
  var e = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    n = r.replace(e, function (f, i, p, s) {
      return i + i + p + p + s + s;
    }),
...
function er(r, e, n) {
  var a = E(e);
  if (X([n, "deg", "rad", "turn"], a)) return e;
  var t = U.CSS[e + n];
  if (!c.und(t)) return t;
  var u = 100,
...
function Mr(r, e, n) {
  if (e in r.style) {
    var a = e.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(),
      t = r.style[e] || getComputedStyle(r).getPropertyValue(a) || "0";
    return n ? er(r, t, n) : t;
  }
}
function nr(r, e) {
...
function wr(r, e) {
  ...
  var n = E(r),
    a = n ? r.substr(0, r.length - n.length) : r;
  return e ? a + e : a;
}
function ir(r, e) {
...
function $r(r) {
  return ir({ x: O(r, "x1"), y: O(r, "y1") }, { x: O(r, "x2"), y: O(r, "y2") });
}
function Pr(r) {
...
function Jr(r, e) {
  var n = c.str(r) ? xr(r)[0] : r,
    a = e || 100;
  return function (t) {
    return { property: t, el: n, svg: Cr(n), totalLength: Ir(n) * (a / 100) };
  };
}
function Yr(r, e, n) {
  function a(s) {
...
function vr(r, e) {
  var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
    a = wr(c.pth(r) ? r.totalLength : r, e) + "";
  return {
    original: a,
...
function Gr(r, e) {
  ...
  return u
    .map(function (o, f) {
      ...
      return (
        c.und(i.delay) && (i.delay = f ? 0 : e.delay),
        c.und(i.endDelay) && (i.endDelay = f === u.length - 1 ? e.endDelay : 0),
        i
      );
    })
    .map(function (o) {
...
var C = [],
  Lr = (function () {
    ...
    function e() {
      !r &&
        (!gr() || !y.suspendWhenDocumentHidden) &&
        C.length > 0 &&
...
function y(r) {
  ...
  function l() {
    (e = 0), (n = s(i.currentTime) * (1 / y.speed));
  }
  function h(g, d) {
    d && d.seek(g - d.timelineOffset);
  }
  function w(g) {
    if (i.reversePlayback) for (var P = u; P--; ) h(g, t[P]);
    else for (var d = 0; d < u; d++) h(g, t[d]);
  }
  function m(g) {
    for (var d = 0, P = i.animations, k = P.length; d < k; ) {
      var x = P[d],
        L = x.animatable,
        F = x.tweens,
        S = F.length - 1,
      ...
      Or[x.type](L.target, x.property, B, L.transforms),
        (x.currentValue = B),
        d++;
    }
  }
  ...
  function M(g) {
    var d = i.duration,
      ...
      k = d - i.endDelay,
      x = s(g);
    (i.progress = D((x / d) * 100, 0, 100)),
      (i.reversePlayback = x < i.currentTime),
      t && w(x),
      !i.began && i.currentTime > 0 && ((i.began = !0), v("begin")),
      !i.loopBegan && i.currentTime > 0 && ((i.loopBegan = !0), v("loopBegin")),
      x <= P && i.currentTime !== 0 && m(0),
      ((x >= k && i.currentTime !== d) || !d) && m(d),
      x > P && x < k
        ? (i.changeBegan ||
        ...
        i.remaining
          ...
          : ((i.paused = !0),
            i.completed ||
              ...
              v("loopComplete"),
              v("complete"),
              !i.passThrough && "Promise" in window && (o(), f(i)))));
  }
  return (
    (i.reset = function () {
      var g = i.direction;
      (i.passThrough = !1),
        ...
        (t = i.children),
        (u = t.length);
      for (var d = u; d--; ) i.children[d].reset();
    ...
    (i.play = function () {
      i.paused &&
        (i.completed && i.reset(), (i.paused = !1), C.push(i), l(), Lr());
    }),
    (i.reverse = function () {
    ...
    if ((f && (o = 0), i && (o = (d - 1) / 2), p && (o = d - 1), !v.length)) {
      for (var P = 0; P < d; P++) {
        if (!t) v.push(Math.abs(o - P));
          ...
          var k = i ? (t[0] - 1) / 2 : o % t[0],
            x = i ? (t[1] - 1) / 2 : Math.floor(o / t[0]),
            L = P % t[0],
            F = Math.floor(P / t[0]),
            S = k - L,
            T = x - F,
            A = Math.sqrt(S * S + T * T);
          u === "x" && (A = -S), u === "y" && (A = -T), v.push(A);
        }
  ...
  return (
    ...
    (e.add = function (n, a) {
      ...
      (i.autoplay = !1),
        ...
        (i.timelineOffset = c.und(a) ? p : ar(a, p)),
        o(e),
        e.seek(i.timelineOffset);
      var s = y(i);
      o(s), u.push(s);
      var l = kr(u, r);
      return (

import {
  ...
  q as isAstroComponentFactory,
  i as renderComponent,
  r as renderTemplate,
  R as ROUTE_TYPE_HEADER,
  u as REROUTE_DIRECTIVE_HEADER,
  A as AstroError,
  v as i18nNoLocaleFoundInPath,
  w as ResponseSentError,
  x as MiddlewareNoDataOrNextCalled,
  y as MiddlewareNotAResponse,
  z as originPathnameSymbol,
  B as RewriteWithBodyUsed,
  G as GetStaticPathsRequired,
  C as InvalidGetStaticPathsReturn,
  D as InvalidGetStaticPathsEntry,
  H as GetStaticPathsExpectedParams,
  J as GetStaticPathsInvalidRouteParam,
  P as PageNumberParamNotFound,
  K as DEFAULT_404_COMPONENT,
  O as NoMatchingStaticPathFound,
  Q as PrerenderDynamicEndpointPathCollide,
  S as ReservedSlotName,
  T as renderSlotToString,
  V as renderJSX,
  W as chunkToString,
  X as isRenderInstruction,
  Y as ForbiddenRewrite,
  Z as SessionStorageSaveError,
  _ as SessionStorageInitError,
  $ as ASTRO_VERSION,
  a0 as LocalsReassigned,
  a1 as PrerenderClientAddressNotAvailable,
  a2 as clientAddressSymbol,
  a3 as ClientAddressNotAvailable,
  a4 as StaticClientAddressNotAvailable,
  a5 as AstroResponseHeadersReassigned,
  a6 as responseSentSymbol$1,
  a7 as renderPage,
  a8 as REWRITE_DIRECTIVE_HEADER_KEY,
  a9 as REWRITE_DIRECTIVE_HEADER_VALUE,
  aa as renderEndpoint,
  ab as LocalsNotAnObject,
  ac as REROUTABLE_STATUS_CODES,
...
import {
  ...
  e as ensure404Route,
} from "./astro-designed-error-pages_DcjKl7WH.mjs";
import "es-module-lexer";
import buffer from "node:buffer";
import crypto$1 from "node:crypto";
import { Http2ServerResponse } from "node:http2";
import {
  a as appendForwardSlash$1,
  j as joinPaths,
  ...
  return function (context, statusCode) {
    if (shouldAppendForwardSlash(trailingSlash, format)) {
      return context.redirect(
        `${appendForwardSlash$1(joinPaths(base, defaultLocale))}`,
        statusCode,
      );
    } else {
...
class App {
  ...
  async render(request, renderOptions) {
    ...
    if (redirect !== url.pathname) {
      ...
      return new Response(
        redirectTemplate({ status, location: redirect, from: request.url }),
        {
          status,
          headers: {
